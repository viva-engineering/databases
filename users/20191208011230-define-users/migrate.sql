...
grant select, insert, update, delete on viva_users.user_preferences to 'viva_auth_service'@'%';
...
grant select, update on viva_users.user to 'viva_user_service'@'%';
grant select, update on viva_users.user_preferences to 'viva_user_service'@'%';
